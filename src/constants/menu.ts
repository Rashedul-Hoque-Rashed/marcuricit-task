    ...
    children: [
      {
        ...
        label: "All Employees",
        url: "/apps/employees/allEmployees",
        parentKey: "apps-employees",
      },
      {
        key: "employees-holidays",
        label: "Holidays",
        url: "/apps/employees/holidays",
        parentKey: "apps-employees",
      },
      {
        key: "employees-leavesAdmin",
        label: "Leaves (Admin)",
        url: "/apps/employees/leavesAdmin",
        parentKey: "apps-employees",
      },
      {
        key: "employees-leavesEmployee",
        label: "Leaves (Employee)",
        url: "/apps/employees/leavesEmployee",
        parentKey: "apps-employees",
      },
      {
        key: "employees-leaveSettings",
        label: "Leave Settings",
        url: "/apps/employees/leaveSettings",
        parentKey: "apps-employees",
      },
      {
        key: "employees-attendanceAdmin",
        label: "Attendance (Admin)",
        url: "/apps/employees/attendanceAdmin",
        parentKey: "apps-employees",
      },
      {
        key: "employees-attendanceEmployee",
        label: "Attendance (Employee)",
        url: "/apps/employees/attendanceEmployee",
        parentKey: "apps-employees",
      },
